...
def PredictTrack(srctracks: list[list[str]], duration: float, num_spans: int) -> list[list[str]]:
    # 输入的项
    track_list = [
        "Event",
        "Time",  # 有用
